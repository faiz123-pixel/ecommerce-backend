...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity)
	{
		...
		.authorizeHttpRequests(request->
		{
			...
			.permitAll()
			.requestMatchers(HttpMethod.POST,"/categories","/products","/orders/**","/users/**","/shipping/**")
			.hasRole("ADMIN")
			.requestMatchers(HttpMethod.GET,"/users/**","/orders/**","/products/**","/shipping/**")
			.hasRole("ADMIN")
			.requestMatchers(HttpMethod.PUT,"/categories/**","/products/**","/orders/**","/users/**","/shipping/**")
			.hasRole("ADMIN")
			.requestMatchers(HttpMethod.DELETE,"/categories/**","/products/**","/orders/**","/users/**","/shipping/**")
			.hasRole("ADMIN")
			.anyRequest()
			.authenticated();
		});
