...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity)
	{
		...
		.authorizeHttpRequests(request->
		{
			...
			.permitAll()
			.requestMatchers(HttpMethod.POST,"/categories","/products","/orders/**")
			.hasRole("ADMIN")
			.requestMatchers(HttpMethod.GET,"/users/**","/orders/**","/products/**")
			.hasRole("ADMIN")
			.requestMatchers(HttpMethod.PUT,"/categories/**","/products/**","/orders/**")
			.hasRole("ADMIN")
			.requestMatchers(HttpMethod.DELETE,"/categories/**","/products/**","/orders/**")
			.hasRole("ADMIN")
			.anyRequest()
			.authenticated();
		});
